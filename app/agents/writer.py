...
class WriterAgent:
    ...
    def node_write_draft(self, state: ComparisonState) -> dict:
        ...
        {{
          "article_body": "지난 3월 25일 보도된 조선일보의 기사는 '절차적 정당성'이라는 해괴한 논리로 본질을 세탁하는 전형적인 행태를 보였다. 이어 3월 26일 중앙일보 역시 이를 받아쓰며 주권자의 눈을 가렸다. 팩트 뒤에 숨은 매체의 비겁한 프레임 전쟁 속에서 진실은 파편화되었고, 남은 것은 진영 논리의 배설뿐이다. 언론이 스스로 권력의 앵무새를 자처하는 한, 우리 사회의 공론장은 회복 불가능한 비극으로 치달을 수밖에 없다."
        }}
        """
