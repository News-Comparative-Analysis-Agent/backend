...
class ReviewAgent:
    ...
    def node_analyze_and_opine(self, state: ReviewState) -> dict:
        ...
        prompt = f"""
            ...
            [상세 설명 및 의견]
            - details 객체 내에 공정성, 무해성에 대한 간략한 평가 사유를 작성합니다.
        ...
        response_schema = {
            ...
            "properties": {
                "metrics": {
                    ...
                    "required": ["perspective_category_count", "emotional_word_ratio", "aggressive_expression_count", "hate_speech_list"]
                },
                "details": {
                    "type": "object",
                    "properties": {
                    ...
                    "required": ["fairness_detail", "harmlessness_detail"]
                },
        ...
        try:
            ...
            if a_count == 0: harmlessness_score += 5
            elif a_count <= 2: harmlessness_score += 3
            elif a_count <= 5: harmlessness_score += 1
            
            total_score = fairness_score + harmlessness_score
            ...
            scores = {
                ...
                "distortions_count": metrics.get('distortion_count', 0)
            }
            ...
            scores = {
                "fairness": {"score": 5, "max_score": 5, "detail": "분석 오류 - 기본 점수 부여"},
                "harmlessness": {"score": 5, "max_score": 5, "detail": "분석 오류 - 기본 점수 부여"},
                "total_score": 10,
                "hate_speech_list": [],
                "distortions_count": 0
            }
